...
const data = [
    {
        ...
        text: "New Checklist has been assigned to you and 2 others. The task priority is set a normal priority, so check and act accordingly. The task date is Thu May 29 2026. Thank you!!!",
        task: null,
        notiType: "alert",
        isRead: [],
    ...
    },
    {
        ...
        text: "New Checklist has been assigned to you and 2 others. The task priority is set a high priority, so check and act accordingly. The task date is Fri June 09 2026. Thank you!!!",
        task: {
